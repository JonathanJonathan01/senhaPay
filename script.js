function gerarSenha(automacao) {
  ...
  setTimeout(() => {
    ...
    document.getElementById("senhaPay").textContent = "Senha Pay";
   document.getElementById("senhaAutomacao").style.display = 'block'
  }, 5000);
...
document.getElementById("senhaPay").addEventListener("click", function () {
  gerarSenha(false);
  document.getElementById("senhaAutomacao").style.display = 'none';
});
